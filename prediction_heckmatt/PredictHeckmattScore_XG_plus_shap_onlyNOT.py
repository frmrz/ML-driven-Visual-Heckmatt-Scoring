...
def generate_shap_plots_for_class(dfOut_skf, X_test, dataDir, result_dir, explainer, feature_names, observations, ii, class_num,seed=123456, link_f='logit'):
    ...
    if link_f == 'logit':
        imgPIL.save(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', img_filename))
    else:
        imgPIL.save(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', img_filename))
    ...
    if link_f == 'logit':
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', beeswarm_plot_filename), dpi=300, bbox_inches='tight')
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', beeswarm_plot_filename_pdf), bbox_inches='tight')  # Save as PDF for vector format
    else:
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', beeswarm_plot_filename), dpi=300, bbox_inches='tight')
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', beeswarm_plot_filename_pdf), bbox_inches='tight')
    ...
    if link_f == 'logit':
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', decision_plot_filename), dpi=300, bbox_inches='tight')
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', decision_plot_filename_pdf), bbox_inches='tight')
    else:
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', decision_plot_filename), dpi=300, bbox_inches='tight')
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', decision_plot_filename_pdf), bbox_inches='tight')
    ...
    if link_f == 'logit':
        ax[1].imshow(plt.imread(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', beeswarm_plot_filename)))
    else:   
        ax[1].imshow(plt.imread(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', beeswarm_plot_filename)))
    ax[1].axis('off')
    
    if link_f == 'logit':
        ax[2].imshow(plt.imread(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', decision_plot_filename)))
    else:
        ax[2].imshow(plt.imread(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', decision_plot_filename)))
    ax[2].axis('off')
    ...
    if link_f == 'logit':
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', final_plot_filename_png), dpi=300, bbox_inches='tight')
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', final_plot_filename_pdf), bbox_inches='tight')
    else:
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', final_plot_filename_png), dpi=300, bbox_inches='tight')
        plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', final_plot_filename_pdf), bbox_inches='tight')
...
threshold = grouped_df_not.shape[0] * 0.1
...
# plt.savefig(os.path.join(result_dir, 'CorrLOW_onlyNOT.png'), bbox_inches='tight')
# plt.savefig(os.path.join(result_dir, 'CorrLOW_onlyNOT.svg'), bbox_inches='tight')
# plt.show()
...
dfX = pd.concat([dfX, filtered_df_not], axis=1)
tp = dfX.dtypes
...
dfX.to_csv(os.path.join(excel_dir, 'preProcessedDF_onlyNOT.csv'),index=False)
...
for ii, (train_index, test_index) in enumerate(skf.split(X, Y, groups)):
    ...
    if link_f == 'logit':
        images = [Image.open(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', filename)) for filename in filenames]
    else:
        images = [Image.open(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', filename)) for filename in filenames]
    ...
    # save the new image
    if link_f == 'logit':
        new_im.save(os.path.join(result_dir, 'SHAP', 'NOT', 'logit', f'CorrectClass_{ii}.png'))
    else:
        new_im.save(os.path.join(result_dir, 'SHAP', 'NOT', 'odds', f'CorrectClass_{ii}_odds.png'))
...
# plt.tight_layout()
# plt.savefig(os.path.join(result_dir, 'Top20Features_onlyNOT.png'), bbox_inches='tight')
# plt.savefig(os.path.join(result_dir, 'Top20Features_onlyNOT.svg'), bbox_inches='tight')
# plt.show()
...
for class_index in range(n_classes):
    ...
    plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', f'ShapSummaryPlot_{class_index}.png'), bbox_inches='tight')
    # clear the plot
    plt.show()
    plt.clf()
    ...
    # write the plot to a file
    plt.savefig(os.path.join(result_dir, 'SHAP', 'NOT', f'ShapBeeswarmPlot_{class_index}.png'), bbox_inches='tight')
    # clear the plot
    # plt.show()
    plt.clf()
...
plt.tight_layout()
plt.savefig(os.path.join(result_dir, 'CM', 'ConfusionMatrix_onlyNOT.png'), bbox_inches='tight')
plt.savefig(os.path.join(result_dir, 'CM', 'ConfusionMatrix_onlyNOT.svg'), bbox_inches='tight')
...
plt.savefig(os.path.join(result_dir, 'RocOVR_onlyNOT.png'), bbox_inches='tight')
plt.savefig(os.path.join(result_dir, 'RocOVR_onlyNOT.svg'), bbox_inches='tight')
plt.show()
...
ax.legend(loc="lower right")
plt.savefig(os.path.join(result_dir, 'CM', 'RocOVO_onlyNOT.png'), bbox_inches='tight')
plt.savefig(os.path.join(result_dir, 'CM', 'RocOVO_onlyNOT.svg'), bbox_inches='tight')
plt.show()
...
plt.tight_layout()
# save the plot
plt.savefig(os.path.join(result_dir, 'HECKMATT', 'BoxplotEIvsH_onlyNOT.png'), bbox_inches='tight')
plt.savefig(os.path.join(result_dir, 'HECKMATT', 'BoxplotEIvsH_onlyNOT.svg'), bbox_inches='tight')
plt.show()
...
plt.tight_layout()
# save the plot
plt.savefig(os.path.join(result_dir, 'HECKMATT', 'BoxplotEIvsH_predicted_onlyNOT.png'), bbox_inches='tight')
plt.savefig(os.path.join(result_dir, 'HECKMATT', 'BoxplotEIvsH_predicted_onlyNOT.svg'), bbox_inches='tight')
plt.show()
...
correlations_df.to_csv(os.path.join(excel_dir, 'CorrelationEIvsH_onlyNOT.csv'), index=False)
